...
export default function VendorSin(){
  return (
    <div class="w-full max-w-md">
        ...
        <form class="space-y-4">
            <div class="flex items-center">
                ...
                <input type="text" class="bg-blue-600 text-white py-2 px-4 rounded w-2/3 text-center"  />
            </div>
            <div class="flex items-center">
                <label class="bg-blue-600 text-white py-2 px-4 rounded mr-2 w-1/3 text-center">Email</label>
                <input type="email" class="bg-blue-600 text-white py-2 px-4 rounded w-2/3 text-center"/>
            </div>
            <div class="flex items-center">
                <label class="bg-blue-600 text-white py-2 px-4 rounded mr-2 w-1/3 text-center">Password</label>
                <input type="password" class="bg-blue-600 text-white py-2 px-4 rounded w-2/3 text-center" />
            </div>
            <div class="flex items-center">
